...
echo setting high-performance scheme to prevent slow operations in the system, low fps in games, etc, so it will behave like desktop PC' 
powercfg -setactive 8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c


echo poweroptions > Power button action > setting for AC (network)
...
echo poweroptions > Power button action > setting for DC (battery)
...
echo poweroptions > choose what close lid does > setting for AC (network)
powercfg -setacvalueindex 8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c 4f971e89-eebd-4455-a8de-9e59040e7347 5ca83367-6e45-459f-a27b-476b1d01c936 0

echo poweroptions > choose what close lid does > setting for DC (battery)
